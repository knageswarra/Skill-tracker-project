...
export class AdminPageComponent implements OnInit {
  ...
  public AssociateSkill: AssociateAndSkills[] = [];
...
ngOnInit() {
  this.getdata();
  this.type = sessionStorage.getItem('type') || ""; // Assign an empty string if sessionStorage.getItem('type') is null
}
